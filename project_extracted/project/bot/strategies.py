...
def get_signal(row, prev, trend, df_full=None):
    signal_type = None
    signal_dir = None
    strategy_name = ""
    ...
    # Strategiya 4: Smart Money Concepts
    if signal_type is None and df_full is not None:
        smc_signal = check_smart_money(row, prev, df_full)
        if smc_signal == "BUY":
            signal_type = "LONG"
            signal_dir = "SMC"
